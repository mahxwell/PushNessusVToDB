...
CREATE TABLE IF NOT EXISTS `NessusVulnerabilities`.`vulnerabilities` (
  ...
  `info_vulnerabilities` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `NessusVulnerabilities`.`risk` (
  ...
  `cve` LONGTEXT NULL,
  `ip_idip` INT NULL,
  `ip_ip1_idip1` INT NULL,
  `ip_ip2_idip2` INT NULL,
  `ip_ip3_idip3` INT NULL,
  `ip_ip4_idip4` INT NULL,
  PRIMARY KEY (`idrisk`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `NessusVulnerabilities`.`acceptation` (
  ...
  `acceptation_description` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `NessusVulnerabilities`.`mesures_att_rem` (
  ...
  `mesures_att_rem_description` VARCHAR(45) NULL,
  PRIMARY KEY (`idmesures_att_rem`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `NessusVulnerabilities`.`ip_has_risk`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `NessusVulnerabilities`.`ip_has_risk` (
  `ip_idip` INT NULL,
  `ip_ip1_idip1` INT NULL,
  `ip_ip2_idip2` INT NULL,
  `ip_ip3_idip3` INT NULL,
  `ip_ip4_idip4` INT NULL,
  `risk_idrisk` INT NULL,
  INDEX `fk_ip_has_risk_risk1_idx` (`risk_idrisk` ASC),
  INDEX `fk_ip_has_risk_ip1_idx` (`ip_idip` ASC, `ip_ip1_idip1` ASC, `ip_ip2_idip2` ASC, `ip_ip3_idip3` ASC, `ip_ip4_idip4` ASC),
  CONSTRAINT `fk_ip_has_risk_ip1`
    FOREIGN KEY (`ip_idip` , `ip_ip1_idip1` , `ip_ip2_idip2` , `ip_ip3_idip3` , `ip_ip4_idip4`)
    REFERENCES `NessusVulnerabilities`.`ip` (`idip` , `ip1_idip1` , `ip2_idip2` , `ip3_idip3` , `ip4_idip4`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ip_has_risk_risk1`
    FOREIGN KEY (`risk_idrisk`)
    REFERENCES `NessusVulnerabilities`.`risk` (`idrisk`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
